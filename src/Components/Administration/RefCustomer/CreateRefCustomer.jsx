                        ...
                        <Form>
                                                ...
                                                <Select options={departOptions} 
                                                    ...
                                                    styles={{
                                                            control: (baseStyles, state) => ({
                                                                ...
                                                                paddingTop: 4,
                                                                paddingBottom: 4,
                                                                borderColor: errors.roleName ? '#ff0c0c' : '#CBD3DF',
                                                                fontFamily: '"Manrope" , sans-serif'
                                                            }),
                                                        }}
                                                    value={departOptions.find(option => option.value === values.roleName)} 
                                                    onChange={(option) => {setFieldValue('roleName', option ? option.value : '')}}
                                                />
                                            </div>
                                        </div>
                                        <div className="single-form-input-sec col-span-4">
                                                ...
                                                <Select options={departOptions} 
                                                    ...
                                                    styles={{
                                                            control: (baseStyles, state) => ({
                                                                ...
                                                                paddingTop: 4,
                                                                paddingBottom: 4,
                                                                borderColor: errors.priceList ? '#ff0c0c' : '#CBD3DF',
                                                                fontFamily: '"Manrope" , sans-serif'
                                                            }),
                                                        }}
                                                    value={departOptions.find(option => option.value === values.priceList)} 
                                                    onChange={(option) => {setFieldValue('priceList', option ? option.value : '')}}
                                                />
                                            </div>
                                        </div>                                       
                                        <div className="single-form-input-sec col-span-4">
                            ...
                            <div className="inner-form-main-section grid grid-cols-12 gap-8">
                                ...
                                <div className="single-form-input-sec col-span-6 text-left">
                                    <ThemeButton onClick={handleSubmit} text={"Add Customer"} type={"submit"}/>
                                </div>
                            </div>
                        </Form>
                    )
...
export default CreateRefCustomer